...
namespace ProductSIte.Controllers
{
    public class CarController : Controller
    {
        ...
        {
            new Car { Id = 6,Make = "Hyundai",Model = "Elantra",Price = 28000,Year = 2020,Color = "Silver",EngineSize = 1600,FuelEfficiency = 34.2,photos = "/Images/elantra.jpg"},
            ...
            new Car { Id = 6,Make = "BMW",Model = "3 Series",Price = 40000,Year = 2021,Color = "Blue",EngineSize = 2000,FuelEfficiency = 28.5,photos = "/Images/bmw3ser.jpg"},
            new Car { Id = 5,Make = "Toyota",Model = "Supra",Price = 45000,Year = 2012,Color = "Dark",EngineSize = 10000,FuelEfficiency = 90.5 ,photos = "/Images/supra.jpg"},
            ...
            new Car { Id = 7,Make = "Ford",Model = "Mustang GT",Price = 50000,Year = 2022,Color = "Red",EngineSize = 5000,FuelEfficiency = 20.1,photos = ""},
            new Car { Id = 8,Make = "Mercedes-Benz",Model = "C-Class",Price = 45000,Year = 2020,Color = "White",EngineSize = 2500,FuelEfficiency = 26.8,photos = "/Images/mers.jpg"},
